...
#define EXPECT_MEMEQ_FULL(p1, n1, p2, n2) EXPECT(memeq_full, p1, n1, p2, n2)
...
void expect_memeq_full(TestContext *ctx, const char *file, int line, const void *p1, size_t n1, const void *p2, size_t n2);
