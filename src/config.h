...
// As above, but without subtracting 1 from the `length` member (for the
// #embed initializers, generated by mk/config2embed.sh)
#define CFG_EMBED(n, t) {.name = n, .text = {.data = t, .length = sizeof(t)}}
