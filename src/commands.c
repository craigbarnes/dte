...
static const Command cmds[] = {
    ...
    CMD("bol", "clst", NA, 0, 0, cmd_bol),
    CMD("bolsf", "cl", NA, 0, 0, cmd_bolsf),
    CMD("bookmark", "r", NA, 0, 0, cmd_bookmark),
    CMD("case", "lu", NA, 0, 0, cmd_case),
    CMD("cd", "", RC, 1, 1, cmd_cd),
    ...
    CMD("def-mode", "u", RC, 1, 16, cmd_def_mode),
    CMD("delete", "", NA, 0, 0, cmd_delete),
    CMD("delete-eol", "n", NA, 0, 0, cmd_delete_eol),
    CMD("delete-line", "S", NA, 0, 0, cmd_delete_line),
    CMD("delete-word", "s", NA, 0, 0, cmd_delete_word),
    CMD("down", "cl", NA, 0, 0, cmd_down),
    CMD("eof", "cl", NA, 0, 0, cmd_eof),
    CMD("eol", "cl", NA, 0, 0, cmd_eol),
    CMD("eolsf", "cl", NA, 0, 0, cmd_eolsf),
    ...
    CMD("setenv", "", RC, 1, 2, cmd_setenv),
    CMD("shift", "", NA, 1, 1, cmd_shift),
    CMD("show", "c", NA, 1, 2, cmd_show),
    CMD("suspend", "", NA, 0, 0, cmd_suspend),
    CMD("tag", "r", NA, 0, 1, cmd_tag),
    CMD("title", "", NA, 1, 1, cmd_title),
    CMD("toggle", "gv", NA, 1, -1, cmd_toggle),
    CMD("undo", "m", NA, 0, 0, cmd_undo),
    CMD("unselect", "", NA, 0, 0, cmd_unselect),
    CMD("up", "cl", NA, 0, 0, cmd_up),
    CMD("view", "", NA, 1, 1, cmd_view),
    CMD("wclose", "fp", NA, 0, 0, cmd_wclose),
    CMD("wflip", "", NA, 0, 0, cmd_wflip),
    CMD("wnext", "", NA, 0, 0, cmd_wnext),
    CMD("word-bwd", "cls", NA, 0, 0, cmd_word_bwd),
    CMD("word-fwd", "cls", NA, 0, 0, cmd_word_fwd),
    CMD("wprev", "", NA, 0, 0, cmd_wprev),
    CMD("wrap-paragraph", "", NA, 0, 1, cmd_wrap_paragraph),
    CMD("wresize", "hv", NA, 0, 1, cmd_wresize),
    CMD("wsplit", "bghnrt", NA, 0, -1, cmd_wsplit),
    CMD("wswap", "", NA, 0, 0, cmd_wswap),
};
