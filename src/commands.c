...
static const Command cmds[] = {
    {"alias", "-", RC, 1, 2, cmd_alias},
    {"bind", "-cnsT=", RC, 1, 2, cmd_bind},
    ...
    {"command", "-", NA, 0, 1, cmd_command},
    {"compile", "-1ps", NA, 2, -1, cmd_compile},
    ...
    {"search", "Hnprw", NA, 0, 1, cmd_search},
