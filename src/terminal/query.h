...
KeyCode parse_dcs_query_reply(StringView seq, bool truncated) WARN_UNUSED_RESULT;
KeyCode parse_osc_query_reply(StringView seq, bool truncated) WARN_UNUSED_RESULT;
