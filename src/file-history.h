...
void file_history_load(FileHistory *hist, ErrorBuffer *ebuf, char *filename, size_t size_limit) NONNULL_ARG(1, 3);
void file_history_save(const FileHistory *hist, ErrorBuffer *ebuf) NONNULL_ARG(1);
