...
bool undo(View *view, ErrorBuffer *ebuf) NONNULL_ARGS WARN_UNUSED_RESULT;
bool redo(View *view, ErrorBuffer *ebuf, unsigned long change_id) NONNULL_ARGS WARN_UNUSED_RESULT;
