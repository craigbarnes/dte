...
void buffer_update_short_filename_cwd(Buffer *buffer, StringView home, const char *cwd) NONNULL_ARG(1);
void buffer_update_short_filename(Buffer *buffer, StringView home) NONNULL_ARGS;
...
bool buffer_filetype_is_none(const Buffer *buffer) NONNULL_ARGS WARN_UNUSED_RESULT;
void buffer_remove_unlock_and_free(PointerArray *buffers, Buffer *buffer, ErrorBuffer *ebuf, const FileLocksContext *locks_ctx) NONNULL_ARG(1, 2, 4);
...
void free_buffers(PointerArray *buffers, ErrorBuffer *ebuf, const FileLocksContext *locks_ctx) NONNULL_ARG(1, 3);
