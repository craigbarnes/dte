...
TEST_CONFIGS := $(addprefix test/data/, $(addsuffix .dterc, \
    env thai crlf join pipe redo replace shift repeat fuzz1 fuzz2 ))
...
feature_tests := $(addprefix build/feature/, $(addsuffix .h, \
    dup3 pipe2 fsync memmem mkostemp sig2str sigabbrev_np TIOCGWINSZ \
    TIOCNOTTY tcgetwinsize posix_madvise ))
