...
# The following compiler warning options are divided into sets and
...
# individually).
# See also: https://gcc.gnu.org/onlinedocs/gcc/Overall-Options.html#:~:text=%40file,-Read
detect_cflags '@mk/cflags/warnings-gcc4.8.txt'
detect_cflags_any '@mk/cflags/warnings-gcc14.txt' '@mk/cflags/warnings-clang18.txt'
detect_cflags "@mk/cflags/warnings-gcc15.txt"
...
detect_cflags '-fstrict-flex-arrays'
